...
☝️ this code will produce an error _"Cannot read property 'title' of undefined"_ because
on the first render of Title component `serverData` is `undefined` indeed.
...
_This pattern of returning `null` on line 8 is called "Early return"._

> When composing components, it is useful to think first about exceptions.
