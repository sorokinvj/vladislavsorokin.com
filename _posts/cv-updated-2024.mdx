...
Frontend Engineer with a blend of full-stack experience and a keen interest in AI.

> Driven by the belief that AI is the future, I focus on building robust, intelligent solutions. My approach combines technical skill with a practical, straightforward mindset. I like to do hard things, build fast and iterate.
...
- **Key Achievement**: Developed the batch payments feature in three weeks, crucial in acquiring Remofirst as a client. Instrumental in aiding sales to acquire prospects.
...
- **JobLander, an AI-Powered Job Interview Assistant** (Ongoing development of a Chrome extension)
- **"Cradle of Mir"**, a 20-meter art object for Burning Man 2013
